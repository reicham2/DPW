...
int main()
{
     ...
     uWS::App()
         ...
         // Maintenance mode (public status + admin management)
         .get("/maintenance", [&](auto *res, auto *req)
              { handle_get_maintenance(res, req, db); })
         .get("/admin/maintenance", [&](auto *res, auto *req)
              { handle_get_admin_maintenance(res, req, db); })
         .put("/admin/maintenance", [&](auto *res, auto *req)
              { handle_put_admin_maintenance(res, req, db, wm); })
         ...
         .get("/admin/container-logs", [&](auto *res, auto *req)
              { handle_get_admin_container_logs(res, req, db); })
         ...
         // ── Camp Planning ─────────────────────────────────────────────────────
         // Sub-collection routes registered before /camps/:id so they win.
         .get("/camps/:id/collaborations", [&](auto *res, auto *req)
              { handle_get_camp_collaborations(res, req, db); })
         .post("/camps/:id/collaborations", [&](auto *res, auto *req)
               { handle_post_camp_collaboration(res, req, db, wm); })
         .patch("/camps/:id/collaborations/:cid", [&](auto *res, auto *req)
                { handle_patch_camp_collaboration(res, req, db, wm); })
         .del("/camps/:id/collaborations/:cid", [&](auto *res, auto *req)
              { handle_delete_camp_collaboration(res, req, db, wm); })

         .get("/camps/:id/categories", [&](auto *res, auto *req)
              { handle_get_camp_categories(res, req, db); })
         .post("/camps/:id/categories", [&](auto *res, auto *req)
               { handle_post_camp_category(res, req, db, wm); })
         .patch("/camps/:id/categories/:cid", [&](auto *res, auto *req)
                { handle_patch_camp_category(res, req, db, wm); })
         .del("/camps/:id/categories/:cid", [&](auto *res, auto *req)
              { handle_delete_camp_category(res, req, db, wm); })

         .get("/camps/:id/periods", [&](auto *res, auto *req)
              { handle_get_camp_periods(res, req, db); })
         .post("/camps/:id/periods", [&](auto *res, auto *req)
               { handle_post_camp_period(res, req, db, wm); })
         .patch("/camps/:id/periods/:pid", [&](auto *res, auto *req)
                { handle_patch_camp_period(res, req, db, wm); })
         .del("/camps/:id/periods/:pid", [&](auto *res, auto *req)
              { handle_delete_camp_period(res, req, db, wm); })

         .get("/camps/:id/day-responsibles", [&](auto *res, auto *req)
              { handle_get_camp_day_responsibles(res, req, db); })
         .post("/camps/:id/day-responsibles", [&](auto *res, auto *req)
               { handle_post_camp_day_responsible(res, req, db, wm); })
         .del("/camps/:id/day-responsibles/:did", [&](auto *res, auto *req)
              { handle_delete_camp_day_responsible(res, req, db, wm); })

         .get("/camps/:id/activities", [&](auto *res, auto *req)
              { handle_get_camp_activities(res, req, db); })
         .post("/camps/:id/activities", [&](auto *res, auto *req)
               { handle_post_camp_activity(res, req, db, wm); })
         .patch("/camps/:id/activities/:aid", [&](auto *res, auto *req)
                { handle_patch_camp_activity(res, req, db, wm); })
         .del("/camps/:id/activities/:aid", [&](auto *res, auto *req)
              { handle_delete_camp_activity(res, req, db, wm); })
         .patch("/camps/:id/schedule-entries/:sid", [&](auto *res, auto *req)
                { handle_patch_schedule_entry(res, req, db, wm); })

         .get("/camps/:id/material-lists", [&](auto *res, auto *req)
              { handle_get_camp_material_lists(res, req, db); })
         .post("/camps/:id/material-lists", [&](auto *res, auto *req)
               { handle_post_camp_material_list(res, req, db, wm); })
         .del("/camps/:id/material-lists/:lid", [&](auto *res, auto *req)
              { handle_delete_camp_material_list(res, req, db, wm); })
         .post("/camps/:id/material-lists/:lid/items", [&](auto *res, auto *req)
               { handle_post_camp_material_item(res, req, db, wm); })
         .patch("/camps/:id/material-items/:mid", [&](auto *res, auto *req)
                { handle_patch_camp_material_item(res, req, db, wm); })
         .del("/camps/:id/material-items/:mid", [&](auto *res, auto *req)
              { handle_delete_camp_material_item(res, req, db, wm); })

         .get("/camps", [&](auto *res, auto *req)
              { handle_get_camps(res, req, db); })
         .post("/camps", [&](auto *res, auto *req)
               { handle_post_camp(res, req, db, wm); })
         .get("/camps/:id", [&](auto *res, auto *req)
              { handle_get_camp(res, req, db); })
         .patch("/camps/:id", [&](auto *res, auto *req)
                { handle_patch_camp(res, req, db, wm); })
         .del("/camps/:id", [&](auto *res, auto *req)
              { handle_delete_camp(res, req, db, wm); })
