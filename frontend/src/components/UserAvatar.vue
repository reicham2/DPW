    ...
    <template v-if="user">
      ...
      <div v-if="open" class="avatar-dropdown">
        <div class="avatar-dropdown-header">
          ...
          <span v-if="user.department" class="avatar-dropdown-dept">{{ user.department }}</span>
          <span class="avatar-dropdown-email">{{ user.email }}</span>
        </div>
        <div class="avatar-dropdown-divider" />
        <router-link class="avatar-dropdown-item" to="/profile" @click="open = false">
          Profil bearbeiten
        </router-link>
        <button class="avatar-dropdown-item avatar-dropdown-logout" @click="handleLogout">
          Abmelden
        </button>
      </div>
    </template>
