...
.item-card {
  background: var(--card-bg); border-radius: 10px; box-shadow: 0 1px 6px rgba(0,0,0,0.06);
  padding: 14px 18px;
}
...
.item-name { font-weight: 600; font-size: 0.95rem; color: var(--text-primary); flex: 1; }
